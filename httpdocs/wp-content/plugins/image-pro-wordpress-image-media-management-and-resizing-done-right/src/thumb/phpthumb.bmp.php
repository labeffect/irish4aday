...
class imagepro_phpthumb_bmp {
	...
	function GD2BMPstring(&$gd_image) {
		...
		for ($y = ($imageY - 1); $y >= 0; $y--) {
			$thisline = '';
			for ($x = 0; $x < $imageX; $x++) {
				$argb = imagepro_phpthumb_functions::GetPixelColor($gd_image, $x, $y);
		...
		$BITMAPFILEHEADER .= imagepro_phpthumb_functions::LittleEndian2String($bmpSize, 4); // DWORD   bfSize;
		$BITMAPFILEHEADER .= imagepro_phpthumb_functions::LittleEndian2String(       0, 2); // WORD    bfReserved1;
		$BITMAPFILEHEADER .= imagepro_phpthumb_functions::LittleEndian2String(       0, 2); // WORD    bfReserved2;
		$BITMAPFILEHEADER .= imagepro_phpthumb_functions::LittleEndian2String(      54, 4); // DWORD   bfOffBits;

		// BITMAPINFOHEADER - [40 bytes] http://msdn.microsoft.com/library/en-us/gdi/bitmaps_1rw2.asp
		$BITMAPINFOHEADER  = imagepro_phpthumb_functions::LittleEndian2String(      40, 4); // DWORD  biSize;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String( $imageX, 4); // LONG   biWidth;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String( $imageY, 4); // LONG   biHeight;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(       1, 2); // WORD   biPlanes;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(      24, 2); // WORD   biBitCount;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(       0, 4); // DWORD  biCompression;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(       0, 4); // DWORD  biSizeImage;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(    2835, 4); // LONG   biXPelsPerMeter;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(    2835, 4); // LONG   biYPelsPerMeter;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(       0, 4); // DWORD  biClrUsed;
		$BITMAPINFOHEADER .= imagepro_phpthumb_functions::LittleEndian2String(       0, 4); // DWORD  biClrImportant;
