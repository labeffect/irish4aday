...
jQuery( document ).ready(function( $ ) {
	...
	if (window.globalBSGalleryActive && window.globalBSGalleryActive=='yes') {
		console.log("here1");
		for(i=0; i<window.globalBSGallery.length;i++)
		{
			(function () {
				console.log("here2");
				jQuery(window.globalBSGallery[i]).carousel({
					interval: 500
				});
			})();
		}
	...
	if (window.globalEscapesSliderActive && window.globalEscapesSliderActive=='yes') {
		for(i=0; i<window.globalEscapesSlider.length;i++)
		{
			if(window.globalEscapesSliderAutoplay[i]=='true')
			$(window.globalEscapesSlider[i]).flexslider({ animation: "slide", directionNav: false, controlNav: true, touch: true, pauseOnHover: true });
			else
			$(window.globalEscapesSlider[i]).flexslider({ animation: "slide", directionNav: false, controlNav: true, touch: true, pauseOnHover: true,slideshow: false });
		}
	}
	if (window.globalSponsorsSliderActive && window.globalSponsorsSliderActive=='yes') {
		for(i=0; i<window.globalSponsorsSlider.length;i++)
		{
			if(window.globalSponsorsSliderAutoplay[i]=='true')
				$(window.globalSponsorsSlider[i]).flexslider({ animation: "slide", directionNav: false, controlNav: true, touch: true, pauseOnHover: true });
			else
				$(window.globalSponsorsSlider[i]).flexslider({ animation: "slide", directionNav: false, controlNav: true, touch: true, pauseOnHover: true,slideshow: false });
		}
	}
