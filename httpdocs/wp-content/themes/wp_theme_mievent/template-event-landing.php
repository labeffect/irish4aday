...
if(!empty($event_id))
{		
	$event_slider= intval(MthemeCore::getPostMeta($event_id, $post_pre.'slider'));
	...
	if(MthemeCore::getPostMeta($event_id, $post_pre.'features_display')=='true')
	{
		...
		$outContent.=do_shortcode('[srizonfbalbum id=1]');
		/*$outContent.=do_shortcode('[srizonfbgallery id=1]');*/
		$outContent.='</div>';
	...
	if(MthemeCore::getPostMeta($event_id, $post_pre.'escape_display')=='true')
	{
		$menuContent=$outContent='';
		if(MthemeCore::getPostMeta($event_id, $post_pre.'escape_menu_active')=='true')
		{
			$heading=MthemeCore::getPostMeta($event_id,$post_pre.'escape_head','escapes');
			$menuContent='<li><a data-scroll href="#escape">'.$heading.'</a></li>';
		}
		
		$category=MthemeCore::getPostMeta($event_id, $post_pre.'escape_cat',"");
				
		$outContent='<div id="escape">';
		$outContent.=do_shortcode('[event_escapes category="'.$category.'"]');
		$outContent.='</div>';
		$menuOrder=MthemeCore::getPostMeta($event_id,$post_pre.'escape_order','5');
	...
	if(MthemeCore::getPostMeta($event_id, $post_pre.'contact_display')=='true')
	{
		...
		$outContent.='</div>';
		$menuOrder=MthemeCore::getPostMeta($event_id,$post_pre.'contact_order','14');
	...
	if(MthemeCore::getPostMeta($event_id, $post_pre.'ext_link_1_display','false')=='true')
	{
		...
		$menuOrder=MthemeCore::getPostMeta($event_id,$post_pre.'ext_link_1_order','10');
		...
		case "2": 
		$category=MthemeCore::getPostMeta($event_id, $post_pre.'more_1_escape_cat',"");
		$outContent.=do_shortcode('[event_escapes category="'.$category.'"]');break;
		case "3": 
	...
	if(MthemeCore::getPostMeta($event_id, $post_pre.'ext_link_2_display','false')=='true')
	{
		...
		$menuOrder=MthemeCore::getPostMeta($event_id,$post_pre.'ext_link_2_order','11');
		...
		$outContent.=do_shortcode('[event_schedules padding="section-padding" category="'.$category.'"]');break;
		case "2": 
		$category=MthemeCore::getPostMeta($event_id, $post_pre.'more_2_escape_cat',"");
		$outContent.=do_shortcode('[event_escapes category="'.$category.'"]');break;
		case "3": 
	...
	if(MthemeCore::getPostMeta($event_id, $post_pre.'ext_link_3_display','false')=='true')
	{
		...
		$menuOrder=MthemeCore::getPostMeta($event_id,$post_pre.'ext_link_3_order','12');
		...
		$outContent.=do_shortcode('[event_schedules padding="section-padding" category="'.$category.'"]');break;
		case "2": 
		$category=MthemeCore::getPostMeta($event_id, $post_pre.'more_3_escape_cat',"");
		$outContent.=do_shortcode('[event_escapes category="'.$category.'"]');break;
		case "3": 
	...
	if(MthemeCore::getPostMeta($event_id, $post_pre.'ext_link_4_display','false')=='true')
	{
		...
		$menuOrder=MthemeCore::getPostMeta($event_id,$post_pre.'ext_link_4_order','13');
		...
		$outContent.=do_shortcode('[event_schedules padding="section-padding" category="'.$category.'"]');break;
		case "2": 
		$category=MthemeCore::getPostMeta($event_id, $post_pre.'more_4_escape_cat',"");
		$outContent.=do_shortcode('[event_escapes category="'.$category.'"]');break;
		case "3": 
...
$menu=$menuContainer6.$menuContainer1.$menuContainer2.$menuContainer3.$menuContainer4.$menuContainer5.$menuContainer7.$menuContainer8.$menuContainer9.$menuContainer10.$menuContainer11.$menuContainer12.$menuContainer13.$menuContainer14.$menuContainer15;
...
<a data-toggle="tooltip" data-placement="bottom" title="" target="_blank" href="https://www.facebook.com/events/107245576485968/" data-original-title="Irish4ADay Event Page">
		<span class="fa-stack">
			<i class="fa fa-circle fa-stack-2x"></i>
		...
		<div class="container-fluid">
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="<?php echo SITE_URL; ?>"><img src="<?php echo MthemeCore::getOption("site_logo",""); ?>" alt="logo"/></a>
					<?php } ?>
			   </div>
