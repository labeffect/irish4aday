...
class MthemeStyle {
	...
	public static function renderFonts() {
		...
		$out.='window.globalEscapesSlider=[];';
		$out.='window.globalSponsorsSlider=[];';
		$out.='window.globalEscapesSliderAutoplay=[];';
		$out.='window.globalSponsorsSliderAutoplay=[];';
