...
$config = array (
	...
	'components' => array(
		...
		'user_footer_scripts' => array(
			...
			array(
				'name' => 'custom',
				'uri' => CHILD_URI.'site/js/custom.js'
			),
		),
		...
		'taxonomies' => array (
			...
			array(
				'taxonomy' => 'escape_cat',
				'object_type' => array('escape'),
				'settings' => array(
					'hierarchical' => true,
					'show_in_nav_menus' => true,			
					'labels' => array(
	                    'name' => __( 'Escape Categories', 'mtheme'),
	                    'singular_name' => __( 'Escape Category', 'mtheme'),
						'menu_name' => __( 'Categories', 'mtheme' ),
	                    'search_items' => __( 'Search Escape Category', 'mtheme'),
	                    'all_items' => __( 'All Escape Categories', 'mtheme'),
	                    'parent_item' => __( 'Parent Escape Category', 'mtheme'),
	                    'parent_item_colon' => __( 'Parent Escape Category', 'mtheme'),
	                    'edit_item' => __( 'Edit Escape Category', 'mtheme'),
	                    'update_item' => __( 'Update Escape Category', 'mtheme'),
	                    'add_new_item' => __( 'Add New Escape Category', 'mtheme'),
	                    'new_item_name' => __( 'New Escape Category Name', 'mtheme'),
	            	),
					'rewrite' => array(
						'slug' => __('escapes', 'mtheme'),
						'hierarchical' => true,
					),
				),				
		...
		'meta_boxes' => array(
			...
			array(
				...
				'options' => array(	
					array(
						'name' => __('Second Button Option', 'mtheme'),
						'id' => 'second_button_option',
						'type' => 'checkbox',
						'default' => 'false'
					),	
					array(	
						'name' => __('Second Button Title', 'mtheme'),
						'description' => __('Enter Second Button Title', 'mtheme'),
						'id' => 'second_event_link_title',
						'type' => 'text',
						'default' => 'Register'
					),
					array(
						'name' => __('Second Button Type', 'mtheme'),
						'description' => __('Select Second Button Type', 'mtheme'),
					...
					array(
						'name' => __('Second Button Text Transform', 'mtheme'),
						'description' => __('Select Second Button Text Transform Option', 'mtheme'),
					...
					array(	
						'name' => __('Second Button Background Transparent Option', 'mtheme'),
					...
					array(	
						'name' => __('Second Button Background Color', 'mtheme'),
						'id' => 'second_button_color',
						'type' => 'color',
						'description' => __('Select Second Button Background Color', 'mtheme'),
						'defendency' => array('base'=>'_event_slider','parent'=>'tr','id'=>'second_button_transpermt_option','value'=>'false','show'=>'off')
					),
					array(
						'name' => __('Second Button Font Color', 'mtheme'),
						'id' => 'second_button_font_color',
						'type' => 'color',
						'description' => __('Select Second Button Font Color', 'mtheme')
					),
					array(	
						'name' => __('Second Button Border', 'mtheme'),
						...
						'default' => "none",
						'description' => __('Select Second Button Border Size', 'mtheme')
					),
					array(	
						'name' => __('Second Button Border Type', 'mtheme'),
						...
						'description' => __('Select Second Button Border Type', 'mtheme')
					),
					array(	
						'name' => __('Second Button Border Radius', 'mtheme'),
						...
						'description' => __('Select Second Button Border Radius', 'mtheme')
					),
					array(
						'name' => __('Second Button Border Color', 'mtheme'),
						'id' => 'second_button_border_color',
						'type' => 'color',
						'description' => __('Select Second Button Border Color', 'mtheme')
					),
					array(	
						'name' => __('Second Button Hover Active', 'mtheme'),
						'description' => __('Select Second Button Hover Background Transparent Option', 'mtheme'),
					...
					array(
						'name' => __('Second Button Hover Background Color', 'mtheme'),
						'id' => 'second_button_hover_bg_color',
						'type' => 'color',
						'description' => __('Select Second Button Hover Background Color', 'mtheme'),
						'defendency' => array('base'=>'_event_slider','parent'=>'tr','id'=>'second_button_hover_transpermt_option','value'=>'true','show'=>'on') 
					),
					array(
						'name' => __('Second Button Hover Font Color', 'mtheme'),
						'id' => 'second_button_hover_font_color',
						'type' => 'color',
						'description' => __('Select Second Button Hover Font Color', 'mtheme'),
						'defendency' => array('base'=>'_event_slider','parent'=>'tr','id'=>'second_button_hover_transpermt_option','value'=>'true','show'=>'on') 
					),
					array(
						'name' => __('Second Button Hover Border Color', 'mtheme'),
						'id' => 'second_button_hover_border_color',
						'type' => 'color',
						'description' => __('Select Second Button Hover Border Color', 'mtheme'),
						'defendency' => array('base'=>'_event_slider','parent'=>'tr','id'=>'second_button_hover_transpermt_option','value'=>'true','show'=>'on') 
					),
					array(	
						'name' => __('Second Button Href Link', 'mtheme'),
						'description' => __('Enter Second Button Href Link', 'mtheme'),
			...
			array(
				...
				'options' => array(	
					...
					array(	
						'name' => __('Event Number of Escapes', 'mtheme'),
						'description' => __('Enter Event Number of Escapes', 'mtheme'),
						'id' => 'event_no_escapes',
						'type' => 'text',
					),
					array(	
						'name' => __('Event Escapes title', 'mtheme'),
						'description' => __('Please enter Escapes title', 'mtheme'),
						'id' => 'event_escapes_title',
						'type' => 'text',
						'default' => 'Hours'
					),
					array(	
						'name' => __('Event Escapes brief', 'mtheme'),
						'description' => __('Enter Event Escapes brief', 'mtheme'),
						'id' => 'event_escapes_brief',
						'type' => 'textarea',
						'wrap' => true,
						'group' => 'group',	
					),
			...
			array(
				...
				'options' => array(	
					...
					/*escape*/
					array(
						'name' => __('Escapes - Display in landing page', 'mtheme'),
						'id' => 'escape_display',
						'description' => __('Escapes - Display in landing page', 'mtheme'),
						'type' => 'select',
						'options' => array(							
							'true' => __('Yes', 'mtheme'),
							'false' => __('No', 'mtheme')
					...
					array(	
						'name' => __('Escapes order Event Landing Page', 'mtheme'),
						'id' => 'escape_order',
						'description' => __('Escapes order Event Landing Page', 'mtheme'),
						'type' => 'select',
						'options' => array(
							'1' => 'One',
							'2' => 'Two',
					...
					array(
						'name' => __('Escapes Menu Active', 'mtheme'),
						'id' => 'escape_menu_active',
						'description' => __('Escapes Menu Active in landing page', 'mtheme'),
						'type' => 'select',
						'options' => array(							
							'true' => __('Yes', 'mtheme'),
							'false' => __('No', 'mtheme')
					...
					array(	
						'name' => __('Escapes Menu Title', 'mtheme'),
						'description' => __('Escapes Menu Title in Event Landing Page', 'mtheme'),
						'id' => 'escape_head',
						'type' => 'text',
						'default' => 'escapes',	
					),
					array(	
						'name' => __('Escapes category', 'mtheme'),
						'id' => 'escape_cat',
						'description' => __('Choose Escapes category', 'mtheme'),
						'type' => 'select_category',
						'taxonomy' => 'escape_cat',
						'wrap' => true,
						'group' => 'group',			
			...
			array(
				'id' => 'escape',
				'title' =>  __('Escape Options', 'mtheme'),
				'page' => 'escape',
				'context' => 'normal',
				'priority' => 'high',
				'options' => array(					
					...
					array(
						...
						'id' => 'designation',
						'type' => 'textarea',
						'description' => __('Enter Escape Designation', 'mtheme'),
					),
					array(
						'name' => __('Twitter URL', 'mtheme'),
						'id' => 'twitter',
						'type' => 'text',
						'description' => __('Enter Escape Twitter URL', 'mtheme'),
					),
					array(
						'name' => __('Facebook URL', 'mtheme'),
						'id' => 'facebook',
						'type' => 'text',
						'description' => __('Enter Escape Facebook URL', 'mtheme'),
					),					
					array(
						'name' => __('Instagram URL', 'mtheme'),
						'id' => 'instagram',
						'type' => 'text',
						'description' => __('Enter Escape Instagram URL', 'mtheme'),
					),
					array(
						'name' => __('Youtube URL', 'mtheme'),
						'id' => 'youtube',
						'type' => 'text',
						'description' => __('Enter Sponsor Youtube URL', 'mtheme'),
					),
			...
			array(
				'id' => 'sponsor',
				'title' =>  __('Sponsor Options', 'mtheme'),
				'page' => 'sponsor',
				'context' => 'normal',
				'priority' => 'high',
				'options' => array(
					...
					array(
						...
						'id' => 'designation',
						'type' => 'textarea',
						'description' => __('Enter Sponsor Designation', 'mtheme'),
					),
					array(
						'name' => __('Sponsor URL Title', 'mtheme'),
						'id' => 'url_title',
						'type' => 'text',
						'description' => __('Enter Sponsor Sponsor URL Title', 'mtheme'),
					),
					array(
						'name' => __('Sponsor URL', 'mtheme'),
						'id' => 'url',
						'type' => 'text',
						'description' => __('Enter Sponsor Sponsor URL', 'mtheme'),
					),
					array(
						'name' => __('Twitter URL', 'mtheme'),
						'id' => 'twitter',
						'type' => 'text',
						'description' => __('Enter Sponsor Twitter URL', 'mtheme'),
					),
					array(
						'name' => __('Facebook URL', 'mtheme'),
						'id' => 'facebook',
						'type' => 'text',
						'description' => __('Enter Sponsor Facebook URL', 'mtheme'),
					),
					array(
						'name' => __('Instagram URL', 'mtheme'),
						'id' => 'instagram',
						'type' => 'text',
						'description' => __('Enter Sponsor Instagram URL', 'mtheme'),
					),
					array(
						'name' => __('Youtube URL', 'mtheme'),
						'id' => 'youtube',
		...
		'texa_meta' => array(
			...
			array(
				'cat_type' => 'escape_cat',
				'context' => 'normal',
				'shortcode_name' => 'escapes',
				'options' => array(
					array(
						'name' => __('Escape Slider Active', 'mtheme'),
						'id' => 'slider',
						'type' => 'select',
					...
					array(
						'name' => __('Escape Slider IS Autoplay', 'mtheme'),
						'id' => 'isautoplay',
						'type' => 'select',
						'prefix' => MTHEME_PREFIX.'spk_',
						'select_options'=>
					...
					array(
						'name' => __('Escape Title Position', 'mtheme'),
						'id' => 'title_position',
						'type' => 'select',
						'prefix' => MTHEME_PREFIX.'spk_',
						'select_options'=>
					...
					array(
						'name' => __('Escape Designation', 'mtheme'),
						'id' => 'designation',
						'type' => 'select',
						'prefix' => MTHEME_PREFIX.'spk_',
						'select_options'=>
					...
					array(
						'name' => __('Escape Designation Position', 'mtheme'),
		...
		'shortcodes' => array(
			...
			array(
				'id' => 'event_escapes',
				'name' => __('Event Escapes', 'mtheme'),
				'shortcode' => '[event_escapes category="{{category}}" slider="{{slider}}"]',
				'options' => array(
					array(
						'id' => 'category',
						'name' => __('Category', 'mtheme'),			
		...
		'custom_styles' => array(
			...
			array(
				'elements' => '.button.dark, .jp-gui, .header-wrap, .header-navigation ul ul, .select-menu, .search-form, .mobile-search-form, .login-button .tooltip-text, .footer-wrap, .site-footer:after, .site-header:after,.tabs nav ul li,.post-details-header .overlay-detail,.social-btn,.page-numbers,.flex-control-paging li a',
				'attributes' => array(
					array(
						'name' => 'background-color',
	...
	'options' => array(
		...
		array(
			...
			array(	
				...
				'id' => 'notify_content',
				'type' => 'textarea',
				'default' => 'Notification In Details',
			),
		/*Contact*/
		array(
			'name' => __('Contact Section', 'mtheme'),
			...
			array(	
				...
				'id' => 'contact_desc',
				'type' => 'textarea',
				'default' => 'Conatct In Details',
			),
			array(	
				'name' => __('Address Title', 'mtheme'),
				'description' => __('Enter Conatct Address Title', 'mtheme'),
			...
			array(	
				...
				'description' => __('Enter Conatct Phone Title', 'mtheme'),
			...
			array(	
				...
				'description' => __('Enter Conatct Email Title', 'mtheme'),
